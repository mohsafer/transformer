    ...
    def test(self):
        ...
        for i in range(len(gt)):
            if gt[i] == 1 and pred[i] == 1 and not anomaly_state:
                anomaly_state = True
                anomaly_detected = True  # Set flag to True when an anomaly is detected
                print(f"Anomaly detected starting at index {i}.")  # Print the anomaly index
        ...
        if not anomaly_detected:  # Check the flag after the loop
